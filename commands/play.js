...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
       ...
       return client.sendTime(message.channel,"❌ | **Failed to connect with server Our team is working on resolving the issue**");
        }
    ...
    SlashCommand: {
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            let awaitchannel = client.channels.cache.get(interaction.channel_id); /// SlashCommand;-;
            ...
            let CheckNode = client.Manager.nodes.get(client.botconfig.Lavalink.id);
            if (!CheckNode || !CheckNode.connected) {
              return client.sendTime(interaction,"❌ | **Failed to connect with server Our team is working on resolving the issue**");
            }
