  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let tempmsg = await message.reply({
      embeds: [new Discord.MessageEmbed().setColor(es.color)
        .setAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/Sw6EWEUGxn")
      ]
    })
    cpuStat.usagePercent(function(e, percent, seconds) {
      ...
      const botinfo = new Discord.MessageEmbed()
        ...
        .setColor("#7dff00").setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
