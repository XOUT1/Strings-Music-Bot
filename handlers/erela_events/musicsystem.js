...
function generateQueueEmbed(client, guildId, leave) {
  ...
  var embeds = [
    ...
    .setDescription(`> *Strings support  <:SpotifyLogo:940609994066395167>  Spotify, <:YouTube:940581287083769857> Youtube, <:SoundCloud:940610687724560454> Soundcloud and direct MP3 Links!*`)
  ]
  ...
  if (!leave && player && player.queue && player.queue.current) {
    embeds[1].setImage(`https://img.youtube.com/vi/${player.queue.current.identifier}/mqdefault.jpg`)
      ...
      .setAuthor(client.getAuthor(`${player.queue.current.title}`, "https://c.tenor.com/HJvqN2i4Zs4AAAAj/milk-and-mocha-cute.gif", player.queue.current.uri))
